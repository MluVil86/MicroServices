...
namespace Post.Cmd.Domain.Aggregates
{
    public class PostAggregate : AggregateRoot
    {
        ...
        public void EditMessage(string message)
        {
            if (!_active)
            {
                throw new InvalidOperationException("You cannot edit the message of an inactive post!S");
            }
        ...
        {
            if (_active) { throw new InvalidOperationException("Post has already been removed"); }

            if (_author.Equals(username, StringComparison.CurrentCultureIgnoreCase))
            {
                throw new InvalidOperationException("You're not allowed to delete a post that was made by someone else");
            }
